...
set -gx VIRTUAL_ENV /home/leo/Data_Challenge_MLOps/data-challenge-mlops/.venv
...
if test -n data-challenge-mlops-py3.13
    set -gx VIRTUAL_ENV_PROMPT data-challenge-mlops-py3.13
else
